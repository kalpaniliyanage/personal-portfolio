...
export default function App() {
    ...
    // Reset unlock state on initial load or refresh so it always asks for passcode when entering/refreshing
    useEffect(() => {
    ...
    // Sync unlock state with sessionStorage
    useEffect(() => {
        const checkUnlock = () => {
            setIsUnlocked(sessionStorage.getItem('portfolio_editor_unlocked') === 'true');
        };
        checkUnlock();
    ...
    return (
        <div className={`min-h-screen flex flex-col font-sans transition-colors duration-200 selection:bg-indigo-500 selection:text-white relative overflow-hidden ${isDarkMode
                ...
                <AnimatePresence>
                    {syncStatus !== 'idle' && (
                        <motion.div
                            ...
                            className={`flex items-center gap-1.5 px-4 py-2 rounded-full border text-xs font-semibold shadow-xl backdrop-blur-md transition-all ${syncStatus === 'syncing'
                ...
                <>
                    ...
                    <div className="fixed bottom-6 right-6 z-50">
                        <motion.button
                            ...
                            className={`flex items-center gap-2 px-5 py-3 rounded-full border text-sm font-bold shadow-xl transition-colors cursor-pointer select-none ${isUnlocked
                                    ? isDarkMode
                ...
                {isLockModalOpen && (
                    <div className="fixed inset-0 z-55 flex items-center justify-center p-4 bg-black/60 backdrop-blur-xs">
                        ...
                        <motion.div
                            ...
                            className={`relative w-full max-w-md rounded-3xl border p-8 shadow-2xl text-center z-10 transition-colors ${isDarkMode
                        ...
                        >
                            ...
                            <button
                                ...
                                className={`absolute top-4 right-4 p-1.5 rounded-full transition-colors cursor-pointer ${isDarkMode ? 'hover:bg-white/10 text-zinc-400 hover:text-white' : 'hover:bg-zinc-100 text-zinc-500 hover:text-zinc-900'
                                    }`}
                            >
                                <X className="h-5 w-5" />
                            </button>
                            ...
                            {justUnlocked ? (
                                <div className="space-y-6 py-4">
                                    ...
                                    <div className="flex flex-col gap-3">
                                        ...
                                        <button
                                            ...
                                            className={`w-full rounded-xl px-4 py-3 font-semibold text-sm border transition-colors cursor-pointer ${isDarkMode
                                ...
                                <div className="space-y-6 py-4">
                                    <div className={`mx-auto h-16 w-16 rounded-2xl flex items-center justify-center border ${isDarkMode ? 'bg-indigo-950/80 text-indigo-300 border-indigo-800/80' : 'bg-indigo-50 text-indigo-600 border-indigo-100'
                                        }`}>
                                ...
                                <div className="space-y-6">
                                    <div className={`mx-auto h-16 w-16 rounded-2xl flex items-center justify-center border ${isDarkMode ? 'bg-indigo-950/80 text-indigo-300 border-indigo-800/80' : 'bg-indigo-50 text-indigo-600 border-indigo-150'
                                        }`}>

...
export default function StudioEditor({ initialData, onSave, scheme, isDarkMode, onClose }: StudioEditorProps) {
    ...
    const [isUnlocked, setIsUnlocked] = useState(() => {
        return sessionStorage.getItem('portfolio_editor_unlocked') === 'true';
    });
    ...
    if (!isUnlocked) {
        return (
            <div className="mx-auto max-w-md px-4 py-20 animate-fade-in relative z-10">
                <div className={`rounded-3xl border p-8 shadow-2xl text-center transition-all ${isDarkMode
                    ...
                    <div className={`mx-auto h-14 w-14 rounded-2xl flex items-center justify-center mb-6 border transition-colors ${isDarkMode
                    ...
                    <div className="space-y-2">
                        <span className={`text-[10px] font-bold tracking-wider uppercase px-2.5 py-1 rounded-full ${isDarkMode ? 'bg-indigo-500/10 text-indigo-300' : 'bg-indigo-50 text-indigo-700'
                            }`}>
                            🔒 Owner-Only configuration
                        </span>
                        <h2 className={`font-display text-2xl font-black tracking-tight mt-2 transition-colors ${isDarkMode ? 'text-white' : 'text-zinc-900'
                            }`}>Unlock Studio Console</h2>
                    </div>

                    <p className={`text-xs mt-3.5 leading-relaxed max-w-xs mx-auto transition-colors ${isDarkMode ? 'text-indigo-200/70' : 'text-zinc-550'
                        }`}>
                    ...
                    <form onSubmit={handleUnlock} className="mt-8 space-y-4">
                        <div>
                            <input
                                ...
                                className={`w-full rounded-xl border px-4 py-3 text-center text-lg font-mono focus:outline-hidden focus:ring-2 transition-all ${isDarkMode
                        ...
                        {onClose && (
                            <button
                                type="button"
                                onClick={onClose}
                                className={`w-full flex items-center justify-center gap-2 rounded-xl px-4 py-3 font-bold text-sm transition-all border active:scale-[0.98] cursor-pointer ${isDarkMode
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10 animate-fade-in">
            <div className="flex flex-col lg:flex-row gap-8">
                ...
                <div className="w-full lg:w-64 shrink-0 space-y-6">
                    <div className={`rounded-2xl border p-5 space-y-5 shadow-xs transition-colors ${isDarkMode ? 'bg-zinc-900 border-zinc-800' : 'bg-white border-zinc-200'
                        }`}>
                        <div className="flex items-center justify-between">
                            <span className={`font-mono text-xs font-bold tracking-wider uppercase transition-colors ${isDarkMode ? 'text-zinc-500' : 'text-zinc-400'
                                }`}>Console</span>
                            <div className="flex items-center gap-3">
                                {onClose && (
                                    <button
                                        onClick={onClose}
                                        className={`text-xs font-semibold cursor-pointer transition-colors flex items-center gap-1 ${isDarkMode ? 'text-indigo-300 hover:text-white' : 'text-indigo-600 hover:text-indigo-850'
                                            }`}
                                    >
                                ...
                                <button
                                    onClick={handleLock}
                                    className={`text-xs font-medium cursor-pointer transition-colors ${isDarkMode ? 'text-zinc-500 hover:text-zinc-300' : 'text-zinc-400 hover:text-zinc-600'
                                        }`}
                                >
                                    Sign Out
                                </button>
                        ...
                        <div className="flex items-center gap-2">
                            <div className={`h-8 w-8 rounded-lg flex items-center justify-center border transition-colors ${isDarkMode
                        ...
                        <div className={`space-y-1.5 pt-4 border-t transition-colors ${isDarkMode ? 'border-zinc-800/80' : 'border-zinc-100'}`}>
                            <button
                                ...
                                className={`w-full flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-sm font-medium transition-colors cursor-pointer ${activeTab === 'personal'
                                        ? isDarkMode
                            ...
                            <button
                                ...
                                className={`w-full flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-sm font-medium transition-colors cursor-pointer ${activeTab === 'projects'
                                        ? isDarkMode
                                            ? `${scheme.darkLightBg} ${scheme.darkText} font-semibold`
                                            : `${scheme.lightBg} ${scheme.text} font-semibold`
                                        : isDarkMode
                            ...
                            <button
                                ...
                                className={`w-full flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-sm font-medium transition-colors cursor-pointer ${activeTab === 'experience'
                                        ? isDarkMode
                                            ? `${scheme.darkLightBg} ${scheme.darkText} font-semibold`
                                            : `${scheme.lightBg} ${scheme.text} font-semibold`
                                        : isDarkMode
                            ...
                            <button
                                ...
                                className={`w-full flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-sm font-medium transition-colors cursor-pointer ${activeTab === 'skills'
                                        ? isDarkMode
                                            ? `${scheme.darkLightBg} ${scheme.darkText} font-semibold`
                                            : `${scheme.lightBg} ${scheme.text} font-semibold`
                                        : isDarkMode
                            ...
                            <button
                                ...
                                className={`w-full flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-sm font-medium transition-colors cursor-pointer ${activeTab === 'passions'
                                        ? isDarkMode
                                            ? `${scheme.darkLightBg} ${scheme.darkText} font-semibold`
                                            : `${scheme.lightBg} ${scheme.text} font-semibold`
                                        : isDarkMode
                            ...
                            <button
                                ...
                                className={`w-full flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-sm font-medium transition-colors cursor-pointer ${activeTab === 'blogs'
                                        ? isDarkMode
                                            ? `${scheme.darkLightBg} ${scheme.darkText} font-semibold`
                                            : `${scheme.lightBg} ${scheme.text} font-semibold`
                                        : isDarkMode
                            ...
                            <button
                                ...
                                className={`w-full flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-sm font-medium transition-colors cursor-pointer ${activeTab === 'custom'
                                        ? isDarkMode
                                            ? `${scheme.darkLightBg} ${scheme.darkText} font-semibold`
                                            : `${scheme.lightBg} ${scheme.text} font-semibold`
                                        : isDarkMode
                    ...
                    {/* Feedback logs */}
                    {saveSuccess && (
                        <div className={`rounded-xl border p-4 shadow-2xs text-xs animate-fade-in ${isDarkMode
                ...
                <div className={`flex-1 rounded-3xl border shadow-xs overflow-hidden transition-colors ${isDarkMode ? 'bg-zinc-900 border-zinc-800/85' : 'bg-white border-zinc-200'
                    }`}>

                    <div className={`p-6 flex items-center justify-between border-b ${isDarkMode ? 'border-zinc-800/60' : 'border-zinc-100'
                        }`}>
                        <div>
                    ...
                    <div className="p-6">
                            ...
                            <div className="space-y-6">
                                <div className="grid gap-6 md:grid-cols-2">
                                    <div className="space-y-1.5">
                                        ...
                                        <input
                                            ...
                                            className={`w-full rounded-xl border px-4 py-2.5 text-sm focus:outline-hidden focus:ring-1 transition-all ${isDarkMode
                                ...
                                <div className="space-y-1.5">
                                    ...
                                    <textarea
                                        ...
                                        className={`w-full rounded-xl border px-4 py-2.5 text-sm focus:outline-hidden focus:ring-1 resize-y transition-all ${isDarkMode
                                                ? 'bg-zinc-950 border-zinc-800 text-white focus:border-zinc-700 focus:ring-zinc-750'
                                                : 'bg-white border-zinc-200 text-zinc-800 focus:border-zinc-400 focus:ring-zinc-400'
                                            }`}
                                    />
                                ...
                                <div className={`space-y-3 pt-4 border-t transition-colors ${isDarkMode ? 'border-zinc-800/80' : 'border-zinc-100'
                                    }`}>
                                    ...
                                    <div className="grid gap-4 md:grid-cols-2 items-center">
                                        ...
                                        />
                                        <div className={`flex flex-col items-center justify-center p-4 border rounded-xl h-full ${isDarkMode ? 'bg-zinc-950/30 border-zinc-800' : 'bg-zinc-50/50 border-zinc-200'
                                            }`}>
                                ...
                                <div className={`grid gap-6 md:grid-cols-3 pt-4 border-t transition-colors ${isDarkMode ? 'border-zinc-800/80' : 'border-zinc-100'
                                    }`}>
                                    <div className="space-y-1.5">
                            ...
                            <div className="space-y-8">
                                ...
                                <div className="space-y-6">
                                    {formData.projects.map((proj, idx) => (
                                        <div key={proj.id} className={`p-5 rounded-2xl border transition-all ${isDarkMode ? 'bg-zinc-950/40 border-zinc-800/80' : 'bg-zinc-50/50 border-zinc-200'
                                            } space-y-4`}>
                                            <div className={`flex items-center justify-between border-b pb-3 transition-colors ${isDarkMode ? 'border-zinc-800/60' : 'border-zinc-200/50'
                                                }`}>
                                            ...
                                            <div className="grid gap-4 md:grid-cols-2">
                                                <div className="space-y-1.5">
                                                    ...
                                                    <input
                                                        ...
                                                        className={`w-full rounded-xl border px-3 py-2 text-sm focus:outline-hidden focus:ring-1 transition-all ${isDarkMode
                                                ...
                                                <div className="space-y-1.5">
                                                    ...
                                                    <input
                                                        ...
                                                        className={`w-full rounded-xl border px-3 py-2 text-sm focus:outline-hidden focus:ring-1 font-mono transition-all ${isDarkMode
                                                                ? 'bg-zinc-900 border-zinc-800 text-white focus:border-zinc-700 focus:ring-zinc-750'
                                                                : 'bg-white border-zinc-200 text-zinc-800 focus:border-zinc-400 focus:ring-zinc-400'
                                                            }`}
                                                    />
                                            ...
                                            <div className="space-y-1.5">
                                                ...
                                                <textarea
                                                    ...
                                                    className={`w-full rounded-xl border px-3 py-2 text-sm focus:outline-hidden focus:ring-1 resize-y transition-all ${isDarkMode
                                                            ? 'bg-zinc-900 border-zinc-800 text-white focus:border-zinc-700 focus:ring-zinc-750'
                                                            : 'bg-white border-zinc-200 text-zinc-800 focus:border-zinc-400 focus:ring-zinc-400'
                                                        }`}
                                                />
                                            ...
                                            <div className={`space-y-3 pt-4 border-t transition-colors ${isDarkMode ? 'border-zinc-800/60' : 'border-zinc-100'
                                                }`}>
                                                <div className="flex items-center justify-between">
                                                ...
                                                {proj.media && proj.media.length > 0 ? (
                                                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                                                        {proj.media.map((med, medIdx) => (
                                                            <div key={medIdx} className={`relative group rounded-xl overflow-hidden border p-1.5 ${isDarkMode ? 'bg-zinc-900 border-zinc-850' : 'bg-white border-zinc-150'
                                                                }`}>
                                                ...
                                                <div className="grid gap-4 md:grid-cols-2 pt-2">
                                                    ...
                                                    <div className={`border rounded-xl p-4 flex flex-col justify-between ${isDarkMode ? 'bg-zinc-950/20 border-zinc-800' : 'bg-zinc-50/50 border-zinc-200'
                                                        }`}>
                                                        <div>
                                                            ...
                                                            <div className="space-y-2 mt-2">
                                                                <div className="grid grid-cols-2 gap-2">
                                                                    <input
                                                                        ...
                                                                        className={`rounded-lg border px-2 py-1 text-xs focus:outline-hidden ${isDarkMode ? 'bg-zinc-900 border-zinc-800 text-white' : 'bg-white border-zinc-200 text-zinc-800'
                                                                            }`}
                                                                    />
                                                                    <select
                                                                ...
                                                                <input
                                                                    ...
                                                                    className={`w-full rounded-lg border px-2.5 py-1 text-xs focus:outline-hidden ${isDarkMode ? 'bg-zinc-900 border-zinc-800 text-white' : 'bg-white border-zinc-200 text-zinc-800'
                                                                        }`}
                                                                />
                                                                <button
                                                                    type="button"
                        ...
                        {activeTab === 'experience' && (
                            <div className="space-y-12 animate-fade-in">
                                    ...
                                    {formData.experience.length === 0 ? (
                                        ...
                                        <div className="space-y-6">
                                            {formData.experience.map((exp, idx) => (
                                                <div key={exp.id} className={`p-5 rounded-2xl border transition-all ${isDarkMode ? 'bg-zinc-950/40 border-zinc-800/80' : 'bg-zinc-50/50 border-zinc-200'
                                                    ...
                                                    <div className={`space-y-3 pt-3 border-t transition-colors ${isDarkMode ? 'border-zinc-800/60' : 'border-zinc-100'
                                                        }`}>
                                                        <div className="flex items-center justify-between">
                                                            ...
                                                            {exp.achievements.map((item, lineIdx) => (
                                                                <div key={lineIdx} className="flex gap-2">
                                                                    <input
                                                                        ...
                                                                        className={`flex-1 rounded-xl border px-3 py-1.5 text-xs focus:outline-hidden focus:ring-1 transition-all ${isDarkMode
                                ...
                                {/* VISUAL SEPARATOR */}
                                <div className={`border-t-2 border-dashed transition-colors ${isDarkMode ? 'border-zinc-800' : 'border-zinc-200'
                                    }`} />
                                    ...
                                    {(formData.academics || []).length === 0 ? (
                                        ...
                                        <div className="space-y-6">
                                            {(formData.academics || []).map((acad, idx) => (
                                                <div key={acad.id} className={`p-5 rounded-2xl border transition-all ${isDarkMode ? 'bg-zinc-950/40 border-zinc-800/80' : 'bg-zinc-50/50 border-zinc-200'
                                                    } space-y-4 animate-fade-in`}>
                                                    <div className={`flex items-center justify-between border-b pb-3 transition-colors ${isDarkMode ? 'border-zinc-800/60' : 'border-zinc-200/50'
                                                        }`}>
                                                        ...
                                                        {acad.images && acad.images.length > 0 ? (
                                                            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                                                                {acad.images.map((imgUrl, imgIdx) => (
                                                                    <div key={imgIdx} className={`relative group rounded-xl overflow-hidden border p-1.5 ${isDarkMode ? 'bg-zinc-900 border-zinc-850' : 'bg-white border-zinc-150'
                                                                        }`}>
                                                                        <div className="aspect-video bg-zinc-950 rounded-lg overflow-hidden flex items-center justify-center">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <div className="space-y-2 mt-2">
                                                                        <input
                                                                            ...
                                                                            className={`w-full rounded-lg border px-2.5 py-1.5 text-xs focus:outline-hidden ${isDarkMode ? 'bg-zinc-900 border-zinc-800 text-white' : 'bg-white border-zinc-200 text-zinc-800'
                                                                                }`}
                                                                        />
                                                                        <button
                                                                            type="button"
                                    ...
                                    {(formData.certifications || []).length === 0 ? (
                                        ...
                                        <div className="space-y-6">
                                            {(formData.certifications || []).map((cert, idx) => (
                                                <div key={cert.id} className={`p-5 rounded-2xl border transition-all ${isDarkMode ? 'bg-zinc-950/40 border-zinc-800/80' : 'bg-zinc-50/50 border-zinc-200'
                                                    } space-y-4 animate-fade-in`}>
                                                    <div className={`flex items-center justify-between border-b pb-3 transition-colors ${isDarkMode ? 'border-zinc-800/60' : 'border-zinc-200/50'
                                                        }`}>
                                                                ...
                                                                <div className="space-y-2 flex flex-col justify-between">
                                                                    ...
                                                                    <div className="space-y-1">
                                                                        ...
                                                                        <input
                                                                            ...
                                                                            className={`w-full rounded-lg border px-2 py-1 text-xs focus:outline-hidden ${isDarkMode ? 'bg-zinc-900 border-zinc-800 text-white' : 'bg-white border-zinc-200 text-zinc-800'
                                                                                }`}
                                                                        />
                                                                    </div>
                                                                </div>
                            ...
                            <div className="space-y-8">
                                ...
                                <div className="space-y-6">
                                    {formData.skills.map((skillCat, idx) => (
                                        <div key={skillCat.id} className={`p-5 rounded-2xl border transition-all ${isDarkMode ? 'bg-zinc-950/40 border-zinc-800/80' : 'bg-zinc-50/50 border-zinc-200'
                                            } space-y-4 animate-fade-in`}>
                                            <div className={`flex items-center justify-between border-b pb-3 transition-colors ${isDarkMode ? 'border-zinc-800/60' : 'border-zinc-200/50'
                                                }`}>
                                        ...
                                        {(['emerald', 'violet', 'amber', 'sky', 'rose', 'indigo'] as AccentColor[]).map((color) => {
                                            ...
                                            return (
                                                <button
                                                    ...
                                                    className={`flex items-center justify-between p-3.5 rounded-xl border text-sm font-semibold transition-all cursor-pointer ${isSelected
                                                            ? isDarkMode
                                ...
                                <div className={`space-y-3 pt-6 border-t transition-colors ${isDarkMode ? 'border-zinc-800/60' : 'border-zinc-100'}`}>
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <button
                                            ...
                                            className={`p-5 rounded-2xl border text-left transition-all cursor-pointer ${formData.customization.layout === 'grid'
                                                    ? isDarkMode
                                        ...
                                        <button
                                            ...
                                            className={`p-5 rounded-2xl border text-left transition-all cursor-pointer ${formData.customization.layout === 'minimal'
                                                    ? isDarkMode
                                                        ? 'border-white ring-1 ring-white bg-zinc-950'
                                                        : 'border-zinc-900 ring-1 ring-zinc-900 bg-zinc-50'
                                                    : isDarkMode
                            ...
                            <div className="space-y-8 animate-fade-in">
                                ...
                                <div className="space-y-6">
                                    {(formData.passions || []).map((passion, idx) => (
                                        <div key={passion.id} className={`p-5 rounded-2xl border transition-all ${isDarkMode ? 'bg-zinc-950/40 border-zinc-800/80' : 'bg-zinc-50/50 border-zinc-200'
                                            } space-y-4 animate-fade-in`}>
                                            <div className={`flex items-center justify-between border-b pb-3 transition-colors ${isDarkMode ? 'border-zinc-800/60' : 'border-zinc-200/50'
                                                }`}>
                                            ...
                                            <div className="grid gap-4 md:grid-cols-2">
                                                ...
                                                <div className="space-y-1.5">
                                                    ...
                                                    <input
                                                        ...
                                                        className={`w-full rounded-xl border px-3 py-2 text-sm font-mono focus:outline-hidden focus:ring-1 transition-all ${isDarkMode
                                                                ? 'bg-zinc-900 border-zinc-800 text-white focus:border-zinc-700 focus:ring-zinc-750'
                                                                : 'bg-white border-zinc-200 text-zinc-800 focus:border-zinc-400 focus:ring-zinc-400'
                                                            }`}
                                                    />
                                            ...
                                            <div className={`space-y-3 pt-3 border-t transition-colors ${isDarkMode ? 'border-zinc-800/60' : 'border-zinc-100'
                                                ...
                                                {passion.images && passion.images.length > 0 ? (
                                                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                                                        {passion.images.map((imgUrl, imgIdx) => (
                                                            <div key={imgIdx} className={`relative group rounded-lg overflow-hidden border p-1 ${isDarkMode ? 'bg-zinc-900 border-zinc-800' : 'bg-white border-zinc-200'
                                                                }`}>
                                                ...
                                                <div className="grid gap-4 md:grid-cols-2 pt-1">
                                                    ...
                                                    <div className={`border rounded-xl p-3 flex flex-col justify-between ${isDarkMode ? 'bg-zinc-950/20 border-zinc-800' : 'bg-zinc-50/50 border-zinc-200'
                                                        }`}>
                                                        <div>
                            ...
                            <div className="space-y-8 animate-fade-in">
                                ...
                                <div className="space-y-6">
                                    {(formData.blogs || []).length === 0 ? (
                                        <div className={`text-center py-10 rounded-2xl border border-dashed ${isDarkMode ? 'border-zinc-800' : 'border-zinc-200'
                                            }`}>
                                        ...
                                        (formData.blogs || []).map((blog, idx) => (
                                            <div key={blog.id} className={`p-5 rounded-2xl border transition-all ${isDarkMode ? 'bg-zinc-950/40 border-zinc-800/80' : 'bg-zinc-50/50 border-zinc-200'
                                                } space-y-4 animate-fade-in`}>
                                                <div className={`flex items-center justify-between border-b pb-3 transition-colors ${isDarkMode ? 'border-zinc-800/60' : 'border-zinc-200/50'
                                                    }`}>
                                                ...
                                                <div className="space-y-1.5">
                                                    ...
                                                    <textarea
                                                        ...
                                                        className={`w-full rounded-xl border px-3 py-2 text-sm focus:outline-hidden focus:ring-1 font-mono resize-y transition-all ${isDarkMode
                                                                ? 'bg-zinc-900 border-zinc-800 text-white focus:border-zinc-700 focus:ring-zinc-750'
                                                                : 'bg-white border-zinc-200 text-zinc-800 focus:border-zinc-400 focus:ring-zinc-400'
                                                            }`}
                                                ...
                                                <div className={`space-y-3 pt-3 border-t transition-colors ${isDarkMode ? 'border-zinc-800/60' : 'border-zinc-100'
                                                    ...
                                                    {blog.attachment ? (
                                                        <div className={`flex items-center justify-between p-3.5 rounded-xl border ${isDarkMode ? 'bg-zinc-900 border-zinc-800' : 'bg-zinc-50 border-zinc-200'
                                                            }`}>
                                                            <div className="flex items-center gap-3">
                                                                <div className={`p-2 rounded-lg ${isDarkMode ? 'bg-emerald-950/40 text-emerald-400' : 'bg-emerald-50 text-emerald-600'
                                                                    }`}>
                                ...
                                <div className="pt-8 border-t border-zinc-800/10 dark:border-zinc-800/60 space-y-6">
                                    ...
                                    <div className="space-y-6">
                                        {(formData.articles || []).length === 0 ? (
                                            <div className={`text-center py-10 rounded-2xl border border-dashed ${isDarkMode ? 'border-zinc-850' : 'border-zinc-200'
                                                }`}>
                                            ...
                                            (formData.articles || []).map((article, idx) => (
                                                <div key={article.id} className={`p-5 rounded-2xl border transition-all ${isDarkMode ? 'bg-zinc-950/40 border-zinc-800/80' : 'bg-zinc-50/50 border-zinc-200'
                                                    } space-y-4 animate-fade-in`}>
                                                    <div className={`flex items-center justify-between border-b pb-3 transition-colors ${isDarkMode ? 'border-zinc-800/60' : 'border-zinc-200/50'
                                                        }`}>

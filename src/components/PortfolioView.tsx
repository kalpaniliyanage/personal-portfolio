        ...
        >
            ...
            <section id="about" className="relative flex flex-col items-center text-center pt-6 pb-4 scroll-mt-20">
                <motion.div variants={itemVariants} className="relative mb-6">
                    {/* Status Badge */}
                    <div className={`mb-6 inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full border text-xs font-mono font-semibold transition-all ${isDarkMode
                    ...
                    <div className="flex flex-col items-center justify-center mt-4">
                        ...
                        >
                            ...
                            <div className={`relative h-56 w-56 sm:h-64 sm:w-64 rounded-[32px] overflow-hidden border-4 p-1 transition-all shadow-2xl bg-slate-900/40 ${isDarkMode ? 'border-indigo-500/60' : 'border-indigo-400'
                                }`}>
                                {personal.avatarUrl ? (
                                    <img
                                    ...
                                    <div className={`h-full w-full rounded-[24px] flex items-center justify-center text-6xl font-display font-bold border ${isDarkMode
                ...
                <motion.h1
                    ...
                    className={`font-display text-4xl sm:text-5xl md:text-6xl font-black tracking-tight max-w-4xl transition-colors ${isDarkMode ? 'text-white' : 'text-zinc-900'
                        }`}
                >
                    Hey, I&apos;m <span className={`text-transparent bg-clip-text bg-gradient-to-r ${isDarkMode ? 'from-indigo-400 via-purple-400 to-pink-400' : `${scheme.gradientFrom} to-violet-650`
                        }`}>{personal.name}</span>
                </motion.h1>
                ...
                <div className="h-10 overflow-hidden mt-5 flex justify-center items-center">
                    <AnimatePresence mode="wait">
                        <motion.p
                            ...
                            className={`text-base sm:text-lg md:text-xl font-bold tracking-tight max-w-3xl flex items-center gap-2 px-4 py-1.5 rounded-full border ${isDarkMode
                ...
                <motion.p
                    variants={itemVariants}
                    className={`mt-3 text-xs sm:text-sm font-semibold tracking-wider font-mono transition-colors uppercase ${isDarkMode ? 'text-indigo-300/60' : 'text-zinc-500'
                        }`}
                >
                    {personal.role}
                </motion.p>
                ...
                <motion.p
                    variants={itemVariants}
                    className={`mt-6 text-sm sm:text-base leading-relaxed max-w-3xl transition-colors ${isDarkMode ? 'text-zinc-400' : 'text-zinc-650'
                        }`}
                >
                    {personal.bio}
                </motion.p>
                ...
                >
                    {personal.location && (
                        <div className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg border ${isDarkMode ? 'bg-zinc-900/50 border-zinc-800/80 text-zinc-300' : 'bg-white border-zinc-200 text-zinc-600'
                            }`}>
                ...
                <motion.div variants={itemVariants} className="mt-8 flex flex-col sm:flex-row gap-4 justify-center items-center">
                    ...
                    <button
                        ...
                        className={`rounded-xl px-7 py-3.5 font-bold text-sm transition-all shadow-xs duration-200 border cursor-pointer ${isDarkMode
                ...
                <div className="grid gap-12 lg:grid-cols-12 items-start">
                    ...
                    <div className="lg:col-span-5 space-y-8">
                        <div className="space-y-3">
                            <span className={`text-xs font-mono font-bold tracking-wider uppercase ${isDarkMode ? scheme.darkText : scheme.text
                                }`}>Discover Me</span>
                            <h2 className={`font-display text-3xl sm:text-4xl font-extrabold tracking-tight transition-colors ${isDarkMode ? 'text-white' : 'text-zinc-900'
                                }`}>You Know About Me</h2>
                        </div>

                        <p className={`text-sm sm:text-base leading-relaxed transition-colors ${isDarkMode ? 'text-zinc-400' : 'text-zinc-650'
                            }`}>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            {(personal.stats || [
                                ...
                                <div
                                    key={st.id}
                                    className={`p-5 rounded-2xl border text-center transition-all ${isDarkMode
                                            ? 'bg-zinc-900/30 border-zinc-850/80 hover:border-zinc-800'
                                            : 'bg-white border-zinc-150 shadow-2xs hover:shadow-sm'
                                        }`}
                                >
                                    <div className={`text-2xl sm:text-3xl font-black font-display ${isDarkMode ? 'text-white' : 'text-zinc-900'
                                        }`}>
                                        {st.value}
                                    </div>
                                    <div className={`mt-1.5 text-[10px] font-mono tracking-wider ${isDarkMode ? 'text-zinc-500' : 'text-zinc-450'
                                        }`}>
                                        {st.label}
                                    </div>
                                </div>
                    ...
                    <div className="lg:col-span-7 space-y-4">
                        {(personal.competencies || [
                            ...
                            <div
                                key={c.id}
                                className={`p-5 sm:p-6 rounded-2xl border flex gap-4 transition-all duration-350 ${isDarkMode
                            ...
                            >
                                <div className={`flex h-12 w-12 shrink-0 items-center justify-center rounded-xl border ${isDarkMode
                                ...
                                <div className="space-y-1">
                                    <h4 className={`text-base font-bold transition-colors ${isDarkMode ? 'text-white' : 'text-zinc-900'
                                        }`}>
                                        {c.title}
                                    </h4>
                                    <p className={`text-xs sm:text-sm leading-relaxed transition-colors ${isDarkMode ? 'text-zinc-400' : 'text-zinc-600'
                                        }`}>
                                        {c.description}
                                    </p>
                                </div>
            ...
            <section id="skills" className="scroll-mt-20 pt-8">
                <div className="mb-10 text-center lg:text-left">
                    ...
                    <h2 className={`font-display text-3xl sm:text-4xl font-extrabold tracking-tight mt-1 transition-colors ${isDarkMode ? 'text-white' : 'text-zinc-900'
                        }`}>Technical Skills</h2>
                    <p className={`mt-2 max-w-xl text-sm transition-colors ${isDarkMode ? 'text-zinc-400' : 'text-zinc-550'
                        }`}>
                ...
                <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                    {skills.map((skillCat) => (
                        ...
                        >
                            <h3 className={`font-display text-base font-bold pb-4 flex items-center gap-2 border-b transition-colors ${isDarkMode ? 'text-white border-zinc-850/60' : 'text-zinc-900 border-zinc-100'
                                }`}>
                                    ...
                                    return (
                                        <div key={skill} className="space-y-1.5">
                                            <div className="flex justify-between items-center text-xs font-mono">
                                                <span className={`font-bold transition-colors ${isDarkMode ? 'text-zinc-200' : 'text-zinc-700'
                                                    }`}>{skill}</span>
            ...
            <section id="projects" className="scroll-mt-20 pt-8">
                <div className="flex flex-col lg:flex-row lg:items-end justify-between mb-10 gap-6">
                    <div className="space-y-2">
                        <span className={`text-xs font-mono font-bold tracking-wider uppercase flex items-center gap-1.5 ${isDarkMode ? scheme.darkText : scheme.text
                            }`}>
                    ...
                    <p className={`max-w-md text-sm transition-colors leading-relaxed ${isDarkMode ? 'text-zinc-400' : 'text-zinc-550'
                        }`}>
                    ...
                    {['All', 'React', 'Node.js', 'Express', 'Database'].map((category) => {
                        ...
                        return (
                            <button
                                ...
                                className={`relative px-4 py-2 text-xs font-mono font-bold uppercase rounded-lg transition-colors cursor-pointer select-none ${isActive
                                        ? 'text-white'
                                        : isDarkMode
                            ...
                            .map((project, idx) => {
                                ...
                                return (
                                    <motion.article
                                        ...
                                        whileHover={{ y: -6 }}
                                        className={`group flex flex-col overflow-hidden rounded-2xl border transition-all duration-300 ${isDarkMode
                                    ...
                                    >
                                        ...
                                        <div className={`relative overflow-hidden aspect-video border-b ${isDarkMode ? 'bg-zinc-950 border-zinc-850/60' : 'bg-zinc-50 border-zinc-100'
                                            }`}>
                                            {project.imageUrl && (
                                                <img
                                        ...
                                        <div className="flex flex-1 flex-col p-6">
                                            <div className="flex-grow space-y-3">
                                                <h3 className={`font-display text-xl font-bold transition-colors group-hover:text-indigo-400 dark:group-hover:text-indigo-300 ${isDarkMode ? 'text-white' : 'text-zinc-900'
                                                    }`}>
                                                    {project.title}
                                                </h3>
                                                <p className={`text-sm leading-relaxed transition-colors ${isDarkMode ? 'text-zinc-300' : 'text-zinc-650'
                                                    }`}>
                                                    {project.description}
                                                </p>
                                            </div>
                                            ...
                                            <div className="mt-4 flex flex-wrap gap-1.5">
                                                {project.tags.map(tag => (
                                                    <span
                                                        key={tag}
                                                        className={`inline-flex items-center rounded-md border px-2 py-0.5 text-xs font-mono transition-colors ${isDarkMode
                                            ...
                                            <div className={`mt-6 flex flex-wrap items-center justify-between gap-3 pt-4 border-t ${isDarkMode ? 'border-zinc-850/60' : 'border-zinc-100'
                                                }`}>
                                                <button
                                                    onClick={() => openProjectMedia(project)}
                                                    className={`flex items-center gap-1.5 text-xs font-semibold cursor-pointer transition-colors ${isDarkMode ? scheme.darkText : scheme.text
                                                        } hover:underline`}
                                                >
                                                ...
                                                {project.githubLink && (
                                                    <a
                                                        ...
                                                        target="_blank"
                                                        rel="noopener noreferrer"
                                                        className={`flex items-center gap-1 text-xs font-semibold transition-colors ${isDarkMode ? 'text-zinc-400 hover:text-white' : 'text-zinc-500 hover:text-zinc-900'
                                                            }`}
                                                    >
                                                        View Repository
                ...
                <div className="grid gap-6 md:grid-cols-2">
                    {academics.map((acad) => (
                        <motion.div
                            key={acad.id}
                            variants={itemVariants}
                            className={`p-6 sm:p-7 rounded-2xl border flex flex-col justify-between transition-all duration-300 ${isDarkMode
                                    ? 'bg-zinc-900/40 border-zinc-850/80 hover:border-zinc-800'
                        ...
                        >
                            <div className="space-y-4">
                                <div className="flex items-start justify-between gap-3">
                                    <div className="space-y-1">
                                        <span className={`inline-flex items-center rounded-md border px-2 py-0.5 text-[10px] font-mono transition-colors ${isDarkMode
                                                ? 'bg-zinc-950/60 border-zinc-800 text-zinc-400'
                                                : 'bg-zinc-50 border-zinc-200 text-zinc-500'
                                            }`}>
                                            {acad.duration}
                                        </span>
                                        <h3 className={`font-display text-lg font-bold mt-1 transition-colors ${isDarkMode ? 'text-white' : 'text-zinc-900'
                                            }`}>
                                            {acad.degree}
                                        </h3>
                                        <p className={`text-sm font-semibold transition-colors ${isDarkMode ? scheme.darkText : scheme.text
                                            }`}>
                                            {acad.institution}
                                        </p>
                                    </div>
                                    <div className={`p-2 rounded-xl border ${isDarkMode ? 'bg-zinc-950/80 border-zinc-800' : 'bg-zinc-50 border-zinc-150'
                                        }`}>
                                        <GraduationCap className={`h-5 w-5 ${isDarkMode ? scheme.darkText : scheme.text}`} />
                                    </div>
                                </div>

                                <p className={`text-sm leading-relaxed transition-colors ${isDarkMode ? 'text-zinc-400' : 'text-zinc-600'
                                    }`}>
                                    {acad.description}
                                </p>
                            </div>
                                ...
                                <div className="mt-6 pt-4 border-t border-zinc-800/10 dark:border-zinc-800/60 flex flex-wrap gap-3">
                                    {acad.images && acad.images.length > 0 ? (
                                        <button
                                            ...
                                            className={`inline-flex items-center gap-1.5 text-xs font-semibold cursor-pointer transition-colors ${isDarkMode ? `${scheme.darkText} hover:text-white` : `${scheme.text} ${scheme.textHover}`
                                                }`}
                                        >
            ...
            <section id="certificates" className="scroll-mt-20 pt-16 border-t border-zinc-800/10 dark:border-zinc-800/60 animate-fade-in">
                <div className="mb-10 text-center lg:text-left">
                    <span className={`text-xs font-mono font-bold tracking-wider uppercase flex items-center gap-1.5 justify-center lg:justify-start ${isDarkMode ? scheme.darkText : scheme.text
                        }`}>
                    ...
                    <p className={`mt-2 max-w-xl text-sm transition-colors leading-relaxed ${isDarkMode ? 'text-zinc-400' : 'text-zinc-550'
                        }`}>
                ...
                {displayCertifications.length === 0 ? (
                    <div className={`p-10 text-center rounded-3xl border border-dashed ${isDarkMode ? 'bg-zinc-900/10 border-zinc-800' : 'bg-zinc-50/30 border-zinc-200'
                        }`}>
                        ...
                        {displayCertifications.map((cert) => {
                            return (
                                <motion.div
                                    ...
                                    variants={itemVariants}
                                    whileHover={{ y: -6 }}
                                    className={`p-5 rounded-2xl border flex flex-col justify-between transition-all duration-300 relative overflow-hidden group ${isDarkMode
                                ...
                                >
                                    ...
                                    <div className={`absolute top-0 left-0 right-0 h-1 transition-all duration-300 ${isDarkMode ? scheme.darkBadgeBg : scheme.badgeBg
                                        }`} />
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="space-y-2">
                                            <div className="flex items-start justify-between gap-2">
                                                <h3 className={`font-display text-sm font-bold transition-colors line-clamp-1 ${isDarkMode ? 'text-white' : 'text-zinc-900'
                                                    }`}>
                                                    {cert.title}
                                                </h3>
                                                <span className={`text-[9px] font-mono font-bold px-1.5 py-0.5 rounded ${isDarkMode
                                            ...
                                            <div className="space-y-1">
                                                <p className={`text-xs transition-colors font-medium ${isDarkMode ? 'text-zinc-400' : 'text-zinc-550'
                                                    }`}>
                                                    🏛️ {cert.issuer}
                                                </p>
                                                {cert.credentialId && (
                                    ...
                                    <div className="mt-5 pt-3 border-t flex items-center justify-between gap-2 border-zinc-800/10 dark:border-zinc-800/60 font-medium">
                                        <button
                                            ...
                                            className={`inline-flex items-center gap-1.5 text-xs font-semibold cursor-pointer hover:underline ${isDarkMode ? `${scheme.darkText} hover:text-white` : `${scheme.text} ${scheme.textHover}`
                                                }`}
                                        >
                                            <Award className="h-3.5 w-3.5" />
                                            View Certificate
                    ...
                    {passions.map((p) => {
                        ...
                        return (
                            <motion.div
                                key={p.id}
                                variants={itemVariants}
                                className={`overflow-hidden rounded-2xl border transition-all duration-300 flex flex-col sm:flex-row ${isDarkMode
                            ...
                            >
                                ...
                                {p.imageUrl && (
                                    <div
                                        ...
                                        className={`relative w-full sm:w-44 h-48 sm:h-auto shrink-0 cursor-pointer overflow-hidden group ${isDarkMode ? 'bg-zinc-950 border-r border-zinc-850' : 'bg-zinc-50 border-r border-zinc-150'
                                            }`}
                                    >
                                        <img
                                            src={p.imageUrl}
                                ...
                                <div className="p-6 flex flex-col justify-between flex-1">
                                    <div className="space-y-3">
                                        <span className={`inline-flex items-center text-[10px] font-mono font-bold tracking-wider ${isDarkMode ? scheme.darkText : scheme.text
                                            }`}>
                                            {p.category}
                                        </span>
                                        <h3 className={`font-display text-lg font-bold transition-colors ${isDarkMode ? 'text-white' : 'text-zinc-900'
                                            }`}>
                                            {p.title}
                                        </h3>
                                        <p className={`text-xs sm:text-sm leading-relaxed transition-colors ${isDarkMode ? 'text-zinc-400' : 'text-zinc-650'
                                            }`}>
                                            {p.description}
                                        </p>
                                    </div>

                                    <div className={`mt-5 pt-3 border-t flex items-center ${isDarkMode ? 'border-zinc-850/60' : 'border-zinc-100'
                                        }`}>
                ...
                <section id="blogs" className="scroll-mt-20 pt-16 border-t border-zinc-800/10 dark:border-zinc-800/60 animate-fade-in">
                    <div className="mb-8 text-center lg:text-left flex flex-col lg:flex-row lg:items-end justify-between gap-6">
                        ...
                        {blogs.length > 0 && articles.length > 0 && (
                            <div className={`p-1 rounded-xl flex gap-1 self-center lg:self-end border ${isDarkMode ? 'bg-zinc-950 border-zinc-850' : 'bg-zinc-100 border-zinc-200'
                                }`}>
                                <button
                                    onClick={() => { playSound('click'); setActiveBlogTab('blogs'); }}
                                    className={`px-4 py-1.5 rounded-lg text-xs font-semibold transition-all cursor-pointer ${activeBlogTab === 'blogs'
                                            ? isDarkMode
                                ...
                                <button
                                    ...
                                    className={`px-4 py-1.5 rounded-lg text-xs font-semibold transition-all cursor-pointer ${activeBlogTab === 'articles'
                                            ? isDarkMode
                                                ? 'bg-zinc-800 text-white shadow-xs'
                                                : 'bg-white text-zinc-900 shadow-xs'
                                            : 'text-zinc-500 hover:text-zinc-800 dark:hover:text-zinc-300'
                        ...
                        <div className="grid gap-8 md:grid-cols-2">
                            {blogs.map((blog) => (
                                <motion.article
                                    ...
                                    className={`group rounded-3xl border overflow-hidden cursor-pointer transition-all duration-300 flex flex-col h-full justify-between ${isDarkMode
                                            ? 'bg-zinc-900/40 border-zinc-850 hover:border-zinc-800 hover:shadow-xl hover:shadow-indigo-950/10'
                                ...
                                >
                                    <div>
                                        ...
                                        <div className="p-6 space-y-3">
                                            ...
                                            <h3 className={`font-display text-lg font-bold transition-colors group-hover:underline ${isDarkMode ? 'text-white group-hover:text-zinc-200' : 'text-zinc-900 group-hover:text-zinc-700'
                                                }`}>
                                                {blog.title}
                                            </h3>

                                            <p className={`text-xs sm:text-sm leading-relaxed line-clamp-3 transition-colors ${isDarkMode ? 'text-zinc-400' : 'text-zinc-650'
                                                }`}>
                                                {blog.excerpt}
                                            </p>
                                        </div>
                                    ...
                                    <div className="p-6 pt-0 space-y-4">
                                        <div className="flex flex-wrap gap-1.5">
                                            {blog.tags.map((t, idx) => (
                                                <span
                                                    key={idx}
                                                    className={`text-[9px] font-mono font-bold px-2 py-0.5 rounded-md ${isDarkMode
                                                            ? `${scheme.darkBadgeBg} ${scheme.darkBadgeText}`
                                                            : `${scheme.badgeBg} ${scheme.badgeText}`
                                                        }`}
                                                >
                                        ...
                                        <div className={`pt-3 border-t flex items-center text-xs font-bold transition-colors ${isDarkMode ? 'border-zinc-850/60 text-zinc-300' : 'border-zinc-100 text-zinc-700'
                                            }`}>
                                            <span>{blog.externalLink ? 'Read External Publication' : 'Read Full Article'}</span>
                                            {blog.externalLink ? (
                                                <ExternalLink className={`h-3.5 w-3.5 ml-auto ${isDarkMode ? scheme.darkText : scheme.text
                                                    }`} />
                                            ) : (
                                                <ChevronRight className={`h-4 w-4 transition-transform group-hover:translate-x-1 ml-auto ${isDarkMode ? scheme.darkText : scheme.text
                                                    }`} />
                                            )}
                                        </div>
                                    </div>
                        ...
                        <div className="grid gap-6 md:grid-cols-2">
                            {articles.map((article) => (
                                <motion.div
                                    key={article.id}
                                    whileHover={{ y: -4 }}
                                    className={`p-6 rounded-3xl border transition-all duration-300 flex flex-col justify-between h-full ${isDarkMode
                                ...
                                >
                                    <div className="space-y-4">
                                        <div className="flex items-start justify-between gap-4">
                                            <div className={`p-3 rounded-2xl border shrink-0 ${isDarkMode ? 'bg-zinc-950 border-zinc-800 text-emerald-400' : 'bg-emerald-50 border-emerald-100 text-emerald-700'
                                                }`}>
                                    ...
                                    <div className="space-y-4 mt-6">
                                        ...
                                        <div className={`pt-4 border-t flex flex-col sm:flex-row gap-3 items-center justify-between transition-colors ${isDarkMode ? 'border-zinc-850/60' : 'border-zinc-100'
                                            }`}>
                                            ...
                                            <div className="flex flex-wrap gap-2 w-full sm:w-auto">
                                                {article.externalLink && (
                                                    <a
                                                        ...
                                                        rel="noopener noreferrer"
                                                        onClick={() => playSound('click')}
                                                        className={`flex-1 sm:flex-initial text-center text-xs font-bold px-4 py-2 rounded-xl border flex items-center justify-center gap-1.5 transition-all cursor-pointer ${isDarkMode
            ...
            <section id="contact" className="scroll-mt-20 pt-8">
                ...
                <div className="grid gap-12 lg:grid-cols-12 items-start">
                    ...
                    <div className="lg:col-span-5 space-y-4">
                        ...
                        {/* Email card */}
                        {personal.email && (
                            <div className={`p-5 rounded-2xl border flex gap-4 transition-all ${isDarkMode ? 'bg-zinc-900/35 border-zinc-850/80 hover:border-zinc-800' : 'bg-white border-zinc-200 shadow-2xs'
                                }`}>
                                <div className={`p-3 rounded-xl border ${isDarkMode ? 'bg-zinc-950 border-zinc-800 text-emerald-400' : 'bg-emerald-50/80 border-emerald-100 text-emerald-600'
                                    }`}>
                                    <Mail className="h-5 w-5" />
                                </div>
                                <div>
                                    <span className="text-[10px] font-mono text-zinc-550 uppercase block">Send Direct Email</span>
                                    <a href={`mailto:${personal.email}`} className={`text-sm sm:text-base font-bold hover:underline transition-colors ${isDarkMode ? 'text-white' : 'text-zinc-900'
                                        }`}>
                                        {personal.email}
                                    </a>
                                </div>
                        ...
                        {personal.location && (
                            <div className={`p-5 rounded-2xl border flex gap-4 transition-all ${isDarkMode ? 'bg-zinc-900/35 border-zinc-850/80 hover:border-zinc-800' : 'bg-white border-zinc-200 shadow-2xs'
                                ...
                                <div className={`p-3 rounded-xl border ${isDarkMode ? 'bg-zinc-950 border-zinc-800 text-indigo-400' : 'bg-indigo-50/80 border-indigo-100 text-indigo-600'
                                    }`}>
                                    <MapPin className="h-5 w-5" />
                                </div>
                                <div>
                                    <span className="text-[10px] font-mono text-zinc-550 uppercase block">Location</span>
                                    <span className={`text-sm sm:text-base font-bold transition-colors ${isDarkMode ? 'text-white' : 'text-zinc-900'
                                        }`}>
                                        {personal.location}
                                    </span>
                                </div>
                        ...
                        {personal.phone && (
                            <div className={`p-5 rounded-2xl border flex gap-4 transition-all ${isDarkMode ? 'bg-zinc-900/35 border-zinc-850/80 hover:border-zinc-800' : 'bg-white border-zinc-200 shadow-2xs'
                                ...
                                <div className={`p-3 rounded-xl border ${isDarkMode ? 'bg-zinc-950 border-zinc-800 text-amber-400' : 'bg-amber-50/80 border-amber-100 text-amber-600'
                                    }`}>
                                    <Phone className="h-5 w-5" />
                                </div>
                                <div>
                                    <span className="text-[10px] font-mono text-zinc-550 uppercase block">Call / WhatsApp</span>
                                    <a href={`tel:${personal.phone}`} className={`text-sm sm:text-base font-bold hover:underline transition-colors ${isDarkMode ? 'text-white' : 'text-zinc-900'
                                        }`}>
                                        {personal.phone}
                                    </a>
                                </div>
                        ...
                        <div className={`p-5 rounded-2xl border flex gap-4 transition-all ${isDarkMode ? 'bg-zinc-900/35 border-zinc-850/80 hover:border-zinc-800' : 'bg-white border-zinc-200 shadow-2xs'
                            ...
                            <div className={`p-3 rounded-xl border ${isDarkMode ? 'bg-zinc-950 border-zinc-800 text-sky-400' : 'bg-sky-50/80 border-sky-100 text-sky-600'
                                }`}>
                                <Globe className="h-5 w-5" />
                            </div>
                            <div className="min-w-0 flex-1">
                                <span className="text-[10px] font-mono text-zinc-550 uppercase block">Live Hosted Portfolio</span>
                                <span className={`text-sm sm:text-base font-bold transition-colors block truncate ${isDarkMode ? 'text-white' : 'text-zinc-900'
                                    }`}>
                    ...
                    <div className="lg:col-span-7">
                        <form
                            ...
                            className={`p-6 sm:p-8 rounded-3xl border space-y-5 transition-all ${isDarkMode
                        ...
                        >
                            <div className="grid gap-5 sm:grid-cols-2">
                                <div className="space-y-1.5">
                                    ...
                                    <input
                                        ...
                                        className={`w-full px-4 py-3 rounded-xl border text-sm transition-all focus:ring-1 focus:outline-hidden ${isDarkMode
                            ...
                            <button
                                type="submit"
                                disabled={isSending}
                                className={`w-full py-3.5 px-6 rounded-xl font-bold text-sm transition-all text-center flex items-center justify-center gap-2 cursor-pointer ${isSending
                    ...
                    <div className="flex gap-4">
                        {personal.github && (
                            <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className={`flex items-center gap-2 px-5 py-3 rounded-xl border font-semibold text-xs transition-all ${isDarkMode
                    ...
                    return (
                        ...
                        >
                            <motion.div
                                ...
                                className={`w-full max-w-4xl rounded-3xl border overflow-hidden shadow-2xl flex flex-col md:flex-row h-[85vh] md:h-[65vh] ${isDarkMode ? 'bg-zinc-950 border-zinc-800' : 'bg-white border-zinc-200'
                                    }`}
                            >
                                {/* Media Content Area */}
                                ...
                                <div className={`p-6 md:w-1/3 flex flex-col justify-between min-h-0 h-1/2 md:h-full ${isDarkMode ? 'bg-zinc-900/90' : 'bg-zinc-50'
                                    }`}>
                                    <div className="space-y-4 overflow-y-auto pr-1">
                                        <div className="flex justify-between items-start gap-2">
                                            <h3 className={`font-display text-lg font-bold ${isDarkMode ? 'text-white' : 'text-zinc-900'
                                                }`}>{selectedProject.title}</h3>
                                            <button
                                                onClick={() => setSelectedProject(null)}
                                                className={`p-1 rounded-lg border transition-colors cursor-pointer ${isDarkMode ? 'border-zinc-800 hover:bg-zinc-850 text-zinc-400 hover:text-white' : 'border-zinc-200 hover:bg-zinc-100 text-zinc-500'
                                                    }`}
                                            >
                                                <X className="h-4 w-4" />
                                            </button>
                                                ...
                                                <div className="grid grid-cols-3 gap-2">
                                                    {finalMediaList.map((med, mid) => (
                                                        <button
                                                            ...
                                                            className={`relative aspect-video rounded-lg overflow-hidden border-2 cursor-pointer transition-all ${activeMediaIndex === mid
                ...
                {selectedAcademic && (
                    ...
                    >
                        <motion.div
                            ...
                            animate={{ scale: 1 }}
                            exit={{ scale: 0.95 }}
                            className={`w-full max-w-4xl rounded-3xl border overflow-hidden shadow-2xl flex flex-col md:flex-row h-[85vh] md:h-[60vh] ${isDarkMode ? 'bg-zinc-950 border-zinc-800' : 'bg-white border-zinc-200'
                                }`}
                        >
                            ...
                            <div className={`p-6 md:w-1/3 flex flex-col justify-between min-h-0 h-1/2 md:h-full ${isDarkMode ? 'bg-zinc-900/90' : 'bg-zinc-50'
                                ...
                                <div className="space-y-4 overflow-y-auto pr-1">
                                    ...
                                    <p className={`text-xs font-semibold ${isDarkMode ? scheme.darkText : scheme.text
                                            ...
                                            <div className="grid grid-cols-4 gap-1.5">
                                                {selectedAcademic.images.map((imgUrl, imgIdx) => (
                                                    <button
                                                        ...
                                                        className={`relative aspect-video rounded overflow-hidden border cursor-pointer transition-all ${activeAcademicImageIdx === imgIdx
                                                                ? isDarkMode ? 'border-indigo-500 scale-[0.98]' : 'border-emerald-500 scale-[0.98]'
                                                                : 'border-transparent opacity-60 hover:opacity-90'
                                                            }`}
                                                    >
                ...
                {selectedPassion && (
                    ...
                    >
                        <motion.div
                            ...
                            animate={{ scale: 1 }}
                            exit={{ scale: 0.95 }}
                            className={`w-full max-w-3xl rounded-3xl border overflow-hidden shadow-2xl flex flex-col md:flex-row h-[75vh] md:h-[55vh] ${isDarkMode ? 'bg-zinc-950 border-zinc-800' : 'bg-white border-zinc-200'
                                }`}
                        >
                            ...
                            <div className={`p-6 md:w-2/5 flex flex-col justify-between min-h-0 h-1/2 md:h-full ${isDarkMode ? 'bg-zinc-900/90' : 'bg-zinc-50'
                                }`}>
                ...
                {selectedCertificate && (
                    ...
                    >
                        <motion.div
                            ...
                            className={`relative max-w-4xl w-full rounded-3xl overflow-hidden shadow-2xl border flex flex-col md:flex-row h-[85vh] md:h-[60vh] cursor-default ${isDarkMode ? 'bg-zinc-900 border-zinc-800' : 'bg-white border-zinc-200'
                                }`}
                        >
                            {/* Media Container */}
                            ...
                            {/* Sidebar metadata */}
                            <div className={`p-6 md:w-80 flex flex-col justify-between min-h-0 h-1/2 md:h-full ${isDarkMode ? 'bg-zinc-900/95' : 'bg-zinc-50'
                                }`}>
                                <div className="space-y-4 overflow-y-auto">
                                    <div className="flex justify-between items-start gap-2">
                                        ...
                                        <button
                                            onClick={() => setSelectedCertificate(null)}
                                            className={`hidden md:block p-1 rounded-lg border transition-colors cursor-pointer ${isDarkMode ? 'border-zinc-800 hover:bg-zinc-850 text-zinc-400 hover:text-white' : 'border-zinc-200 hover:bg-zinc-100 text-zinc-500'
                                                }`}
                                        >
                                            <X className="h-4 w-4" />
                                        </button>
                                    ...
                                    <h3 className={`font-display text-lg font-bold leading-snug ${isDarkMode ? 'text-white' : 'text-zinc-900'
                ...
                {selectedBlog && (
                    ...
                    >
                        <motion.div
                            ...
                            animate={{ scale: 1, y: 0 }}
                            exit={{ scale: 0.95, y: 15 }}
                            className={`w-full max-w-3xl rounded-3xl border overflow-hidden shadow-2xl flex flex-col max-h-[90vh] ${isDarkMode ? 'bg-zinc-950 border-zinc-800' : 'bg-white border-zinc-200'
                                }`}
                        >
                            {/* Header bar */}
                            <div className={`p-6 border-b flex items-center justify-between ${isDarkMode ? 'border-zinc-850 bg-zinc-950/40' : 'border-zinc-150 bg-zinc-50/50'
                                }`}>
                                <div className="flex items-center gap-3">
                                    <BookOpen className={`h-5 w-5 ${isDarkMode ? scheme.darkText : scheme.text}`} />
                                    <span className={`text-xs font-mono font-bold uppercase tracking-widest ${isDarkMode ? 'text-zinc-400' : 'text-zinc-550'
                                        }`}>Blog Article Reader</span>
                                </div>

                                <button
                                    onClick={() => setSelectedBlog(null)}
                                    className={`p-1.5 rounded-lg border transition-colors cursor-pointer ${isDarkMode ? 'border-zinc-800 hover:bg-zinc-850 text-zinc-400 hover:text-white' : 'border-zinc-200 hover:bg-zinc-100 text-zinc-500'
                                        }`}
                                >
                            ...
                            <div className="overflow-y-auto p-6 md:p-8 space-y-6">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <h1 className={`font-display text-2xl sm:text-3xl font-extrabold tracking-tight transition-colors leading-tight ${isDarkMode ? 'text-white' : 'text-zinc-900'
                                        }`}>
                                        {selectedBlog.title}
                                    </h1>
                                    ...
                                    <div className="flex flex-wrap gap-1.5">
                                        {selectedBlog.tags.map((t, idx) => (
                                            <span
                                                key={idx}
                                                className={`text-[10px] font-mono font-bold px-2 py-0.5 rounded-md ${isDarkMode
                                                        ? `${scheme.darkBadgeBg} ${scheme.darkBadgeText}`
                                                        : `${scheme.badgeBg} ${scheme.badgeText}`
                                                    }`}
                                            >
                                ...
                                {selectedBlog.attachment && (
                                    <div className={`p-4 rounded-2xl border flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 transition-all ${isDarkMode ? 'bg-zinc-900/40 border-zinc-800' : 'bg-emerald-50/30 border-emerald-100'
                                        }`}>
                                        <div className="flex items-center gap-3">
                                            <div className={`p-2.5 rounded-xl ${isDarkMode ? 'bg-emerald-950/40 text-emerald-400' : 'bg-emerald-50 text-emerald-700'
                                                }`}>
                                ...
                                {selectedBlog.externalLink && (
                                    <div className={`p-4 rounded-2xl border flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 transition-all ${isDarkMode ? 'bg-zinc-900/50 border-indigo-900/60' : 'bg-indigo-50/50 border-indigo-100'
                                        }`}>
                                        <div className="flex items-center gap-3">
                                            <div className={`p-2.5 rounded-xl ${isDarkMode ? 'bg-indigo-950/50 text-indigo-400' : 'bg-indigo-50 text-indigo-700'
                                                }`}>
                                ...
                                {/* Main Text Content */}
                                <div className={`text-sm sm:text-base leading-relaxed space-y-4 font-normal transition-colors ${isDarkMode ? 'text-zinc-300' : 'text-zinc-700'
                                    }`}>
                                    {selectedBlog.content.split('\n\n').map((paragraph, pIdx) => {
                                        if (paragraph.startsWith('### ')) {
                                            return (
                                                <h3 key={pIdx} className={`font-display text-lg sm:text-xl font-bold pt-4 pb-1 transition-colors ${isDarkMode ? 'text-white' : 'text-zinc-900'
                                                    }`}>
                                                    {paragraph.replace('### ', '')}
                                                </h3>
                                            );
                            ...
                            {/* Footer bar */}
                            <div className={`p-4 border-t text-center ${isDarkMode ? 'border-zinc-850 bg-zinc-950/20' : 'border-zinc-150 bg-zinc-50/20'
                                }`}>
